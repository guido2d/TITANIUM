    ...
    <div class="container-fluid">
        <div class="row">
            <div class="block green-block">
                <h1 class="animated fadeInLeft">Terminación</h1>
            </div>
        </div>
        
        <div class="row">
            <div class="banner-terminacion"></div>
        </div>
    </div>
</section>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 decorativas p0">
                <div class="title">
                    <h3 class="animated fadeInLeft">Pintura aluminizada</h3>
                </div>
                <div class="subsecciones">
                    <div class="row">
                        <div class="col-md-6 odd">
                            <a href="#">Pintura aluminizada</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 aluminio p0">
                <div class="title">
                    <h3 class="animated fadeInRight">Pintura para Geotextil</h3>
                </div>
                <div class="subsecciones">
                    <div class="row">
                        <div class="col-md-6 odd">
                            <a href="#">Pintura para Geotextil</a>
                        </div>
                    </div>
                </div>
            </div>
