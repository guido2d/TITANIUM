    ...
    <div class="container-fluid">
        <div class="row">
            <div class="block yellow-block">
                <h1 class="animated fadeInLeft">Imprimantes</h1>
            </div>
        </div>
        
        <div class="row">
            <div class="banner-imprimantes"></div>
        </div>
    </div>
</section>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 decorativas p0">
                <div class="title">
                    <h3 class="animated fadeInLeft">Emulsión Acuosa</h3>
                </div>
                <div class="subsecciones">
                    <div class="row">
                        <div class="col-md-6 odd">
                            <a href="#">Emulsión acuosa</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 aluminio p0">
                <div class="title">
                    <h3 class="animated fadeInRight">Pintura Asfáltica</h3>
                </div>
                <div class="subsecciones">
                    <div class="row">
                        <div class="col-md-6 odd">
                            <a href="#">Pintura Asfáltica</a>
                        </div>
                    </div>
                </div>
            </div>
